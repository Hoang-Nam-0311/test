                    ...
                    <div class="row single-slide align-items-center d-flex">
                        <div class="col-lg-8 col-md-4">
                            <div class="banner-content">
                                ...
                                <span>Glashütte the world-famous home of German horology for 81 years. And in the middle of
                                    it
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8">
                            <div class="single-deal">
                                ...
                                <img class="img-fluid w-100 pic" src="{{ url('') }}/assets/img/banner/blog-02.webp"
                                    alt="">
                                <a href="{{ url('') }}/assets/img/banner/blog-02.webp" class="img-pop-up"
                                    target="_blank">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-deal">
                                <div class="overlay"></div>
                                <img class="img-fluid w-100 pic" src="{{ url('') }}/assets/img/banner/blog-09.webp"
                                    alt="">
                                <a href="{{ url('') }}/assets/img/banner/blog-09.webp" class="img-pop-up"
                                    target="_blank">
                                    <div class="deal-details">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="single-deal">
                                <div class="overlay"></div>
                                <img class="img-fluid w-100 pic" src="{{ url('') }}/assets/img/banner/blog-04.webp"
                                    alt="">
                                <a href="{{ url('') }}/assets/img/banner/blog-04.webp" class="img-pop-up"
                                    target="_blank">
                                    <div class="deal-details">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="single-deal">
                                <div class="overlay"></div>
                                <img class="img-fluid w-100 pic" src="{{ url('') }}/assets/img/banner/blog-10.webp"
                                    alt="">
                                <a href="{{ url('') }}/assets/img/banner/blog-10.webp" class="img-pop-up"
                                    target="_blank">
                                    <div class="deal-details">
        ...
        <div class="container">
            <div class="row">
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ url('') }}/assets/img/brand/1.png"
                        alt="">
                </a>
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ url('') }}/assets/img/brand/2.png"
                        alt="">
                </a>
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ url('') }}/assets/img/brand/3.png"
                        alt="">
                </a>
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ url('') }}/assets/img/brand/4.png"
                        alt="">
                </a>
                <a class="col single-img" href="#">
                    <img class="img-fluid d-block mx-auto" src="{{ url('') }}/assets/img/brand/5.png"
                        alt="">
                </a>
            </div>
        </div>
                ...
                <div class="col-lg-3">
                    <div class="ctg-right">
                        <a href="#" target="_blank">
                            <img class="img-fluid d-block mx-auto" src="{{ url('') }}/assets/img/category/c5.jpg"
                                alt="">
                        </a>
                    </div>
                </div>
