  ...
  <div class="wrapper">
    <header class="main-header">
      ...
      <a href="index2.html" class="logo">
        ...
        <span class="logo-lg">Trung Tâm Nghiện</span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-th"></i> <span>QL Thuộc Tính</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
              <li><a href="{{route('attribute.index')}}"><i class="fa fa-circle-o"></i> Danh sách</a></li>
              <li><a href="{{route('attribute.create')}}"><i class="fa fa-circle-o"></i> Thêm mới</a></li>
            </ul>
          </li>
