        ...
        <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
            <div class="col-first">
                ...
                <nav class="d-flex align-items-center">
                    <a href="index.html">Cart<span class="lnr lnr-arrow-right"></span></a>
                    ...
                    <div class="order_box">
                        ...
                        <div class="payment_item active">
                            <div class="radion_btn">
                                ...
                                <img src="{{url('')}}/assets/img/product/card.jpg" alt="">
                                <div class="check"></div>
                            </div>
                        ...
                        <a class="primary-btn" href="#" onclick="">Proceed to Paypal</a>
                    </div>
                </div>
            </div>
        </div>
